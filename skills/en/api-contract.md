# AShareHub exact public API contract

Generated from the V2 OpenAPI contract. It lists every REST endpoint, SDK method, MCP tool, request parameter and response field.
